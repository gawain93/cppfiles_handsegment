...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fill_holes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhri-dz/catkin_ws/install/${idir}'.  Ask the maintainer 'dhri-dz <dhri-dz@todo.todo>' to fix it.")
    endif()
